...
class GatedGCNContext(nn.Module):
    ...
    def __init__(self, inpt_size, hidden_size, output_size, posemb_size, dropout=0.5):
        ...
        self.conv1 = My_GatedGCN(inpt_size + posemb_size, hidden_size)
        self.conv2 = My_GatedGCN(hidden_size, hidden_size)
        self.conv3 = My_GatedGCN(hidden_size, hidden_size)
...
class GatedGCN(nn.Module):
    ...
    def __init__(self, input_size, output_size, embed_size, utter_hidden_size, 
        ...
        self.gcncontext = GatedGCNContext(utter_hidden_size+user_embed_size,
                                          context_hidden_size,
                                          context_hidden_size, 
                                          position_embed_size, 
                                          dropout=dropout)
