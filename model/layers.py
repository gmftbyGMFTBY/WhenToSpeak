...
class My_DoubleGatedGCN_unshared(MessagePassing):
    ...
    def __init__(self, in_channels, out_channels):
        super(My_DoubleGatedGCN_unshared, self).__init__(aggr='mean')
        
        # kernel is a Gated GRUCell
        self.rnn1 = nn.GRUCell(in_channels, in_channels)
        self.rnn2 = nn.GRUCell(in_channels, in_channels)
        self.linear = nn.Linear(in_channels, out_channels)
        self.in_channels = in_channels
        self.out_channels = out_channels
